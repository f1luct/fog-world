...
呵一口气让雾更厚（电脑按住空格，手机用掌心捂），再把手掌贴上去：
掌印融穿玻璃，你就到外面了。
...
| 幕 | 操作 |
|---|---|
| 车窗 | 按住拖动＝擦雾 · 按住 `空格`＝呵气蒙雾（手机：长按时掌温自动起雾） · 雾厚处按住不动＝手掌贴上去，融穿 |
| 窗外 | 拖动＝环顾 · `WASD`＝走在水面上（手机：长按） · `空格`＝呼出白气（桌面） · 左上角「回到玻璃后」返回 |
...
src/
  ...
  breath.js    呼吸输入(空格/掌温;麦克风版在 git 历史里)
